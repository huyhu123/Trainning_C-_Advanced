...
void print2d_util(tree_node_t* g_root, int space)
{
    // Base case
    if (g_root == NULL)
        return;
    ...
    print2d_util(g_root->right, space);
    ...
    // Process left child
    print2d_util(g_root->left, space);
}
